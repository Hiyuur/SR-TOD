...
from .class_names import (cityscapes_classes, coco_classes,
                          ...
                          oid_challenge_classes, oid_v6_classes, voc_classes,drones_classes,visdrone_classes,aitod_classes,tinyperson_classes,dota_classes,airbus_classes,dior_classes,soda_d_classes)
...
__all__ = [
    ...
    'evaluateImgLists', 'YTVIS', 'YTVISeval', 'drones_classes', 'visdrone_classes', 'aitod_classes', 'tinyperson_classes', 'dota_classes', 'airbus_classes','dior_classes','soda_d_classes'
]
