...
def visdrone_classes():
    return ['pedestrian','people','bicycle','car','van',
...
def dior_classes():
    return ['Airplane', 'Airport', 'Baseball field', 'Basketball court', 'Bridge', 'Chimney', 'Dam', 'Expressway service area',
...
def soda_d_classes():
    return ['people', 'rider', 'bicycle', 'motor', 'vehicle',
