...
__all__ = [
    ...
    'ADE20KInstanceDataset', 'iSAIDDataset', 'DronesDataset', 'VisDroneDataset', 'AITODDataset', 'TinyPersonDataset', 'DOTADataset', 'AirBusDataset', 'DiorDataset', 'SODA_DDataset'
]
