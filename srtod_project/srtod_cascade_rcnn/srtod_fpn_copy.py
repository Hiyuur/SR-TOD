...
class SRTOD_FPN(BaseModule):
    ...
    def __init__(
        ...
        RH_in_channels: int = 256,
        RH_out_channels: int = 3,
        ...
        # self.up1 = Up_direct(256,128)
        # self.up2 = Up_direct(128,64)
        # self.out_conv = OutConv(64, 3)
        self.rh = RH(RH_in_channels,RH_out_channels)
    ...
    def forward(self, inputs: Tuple[Tensor]) -> tuple:
        ...
        #draw_feature_map(inputs,save_dir = "/root/nas-public-tju/mmdet/result/my_cascade_rcnn/u_fpn/v2/Drones/feat/up")
        ...
        # P0 = self.up1(outs[0].clone())
        # P0 = self.up2(P0)
        # r_img = self.out_conv(P0)
        r_img = self.rh(outs[0].clone())

        return tuple(outs), r_img
